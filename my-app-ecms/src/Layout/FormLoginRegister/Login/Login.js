...
function validate(id) {
    ...
    for (let i = 0; i < formInput.length; i++) {
      if (formInput[i].value === '') {
        formInput[i].parentNode.querySelector('.error-message').innerText = `Vui lòng nhập ${formInput[i], id} để đăng nhập !!!`
      } else {
            ...
            <div>
              <div class="forms">
                      ...
                      <div class="form-controls">  
                          ...
                          <div class="form-controls form-joinfree"> <p>Don't have account?</p>  <p class="text-blue">Join free today</p></div>
                          </div> 
          </div>
